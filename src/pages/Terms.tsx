...
const Terms = (): React.ReactElement => (
  <>
    <Box m={3} p={3} style={{ marginTop: '64px' }}>
      <h2><strong>Terms and Conditions</strong></h2>

      <p>Welcome to SubLinked!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use of
        SubLinked&apos;s Website, located at https://sublinked.herokuapp.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions.
        Do not continue to use SubLinked if you do not
      ...
      <p>
        ...
        and ourselves. All terms refer to the offer, acceptance
      ...
      <p>
        We employ the use of cookies. By accessing SubLinked,
        you agreed to use cookies in agreement with the SubLinked&apos;s Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, SubLinked and/or its
        licensors own the intellectual property rights for
        all material on SubLinked. All intellectual property
        rights are reserved. You may access this from SubLinked
        for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from SubLinked</li>
        <li>Sell, rent or sub-license material from SubLinked</li>
        <li>Reproduce, duplicate or copy material from SubLinked</li>
        <li>Redistribute content from SubLinked</li>
      </ul>
      ...
      <p>
        ...
        areas of the website. SubLinked does not filter, edit,
        publish or review Comments prior to their presence on
        the website. Comments do not reflect the views and
        opinions of SubLinked,its agents and/or affiliates.
        Comments reflect the views and opinions of the person
        who post their views and opinions. To the extent permitted
        by applicable laws, SubLinked shall not be liable for the
      ...
      <p>
        SubLinked reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant SubLinked a non-exclusive license
      ...
      <p>
        ...
        hyperlink compensates the absence of SubLinked; and (d)
      ...
      <p>
        ...
        you must inform us by sending an e-mail to SubLinked.
        Please include your name, your organization name,
        contact information as well as the URL of your site,
        a list of any URLs from which you intend to link to our
      ...
      <p>
        No use of SubLinked&apos;s logo or other artwork will be allowed
      ...
      <p>
        ...
        (a) are subject to the preceding paragraph; and (b)
