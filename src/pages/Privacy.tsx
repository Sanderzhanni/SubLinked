...
const Privacy = (): React.ReactElement => (
  <>
    <Box m={3} p={3} style={{ marginTop: '64px' }}>
      <h1>Privacy Policy for SubLinked</h1>

      <p>
        At SubLinked, accessible from https://sublinked.herokuapp.com/,
        one of our main priorities is the privacy of
        our visitors. This Privacy Policy document contains
        types of information that is collected and recorded by
        SubLinked and how we use it.
      </p>
      ...
      <p>
        ...
        information that they shared and/or collect in SubLinked.
      ...
      <p>
        ...
        and agree to its terms. For our Terms and Conditions,
        {/* eslint-disable-next-line */}
        please visit the <a href="/terms-and-conditions">Terms & Conditions Page</a>
        .
      </p>
      ...
      <p>
        SubLinked follows a standard procedure of using log files.
      ...
      <p>
        Like any other website, SubLinked uses &apos;cookies&apos;.
      ...
      <p>
        ...
        {/* eslint-disable-next-line */}
        read <a href="https://www.cookieconsent.com/what-are-cookies/">"What Are Cookies" from Cookie Consent</a>
        .
      </p>
      ...
      <p>
        ...
        Policy for each of the advertising partners of SubLinked.
      </p>
      ...
      <p>
        ...
        on SubLinked, which are sent directly to users&apos; browser.
      ...
      <p>
        Note that SubLinked has no access to or control over
      ...
      <p>
        SubLinked&apos;s Privacy Policy does not apply to other
      ...
      <p>
        The right to erasure – You have the right to request t
        hat we erase your personal data, under certain conditions.
      </p>
      <p>
      ...
      <p>
        SubLinked does not knowingly collect any Personal
        ...
        to contact us immediately and we will do our best
